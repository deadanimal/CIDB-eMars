<%@ Control Language="C#" CodeBehind="Integer_Edit.ascx.cs" Inherits="MAT.WebApp.App.Integer_EditField" %>
...
<asp:RangeValidator runat="server" ID="RangeValidator1" CssClass="DDControl DDValidator help-block" ControlToValidate="TextBox1" Type="Integer"
