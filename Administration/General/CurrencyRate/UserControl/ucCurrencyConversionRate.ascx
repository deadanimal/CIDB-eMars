<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucCurrencyConversionRate.ascx.cs" Inherits="MAT.WebApp.App.Administration.General.CurrencyRate.UserControl.ucCurrencyConversionRate" %>
