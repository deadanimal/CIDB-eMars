<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="MAT.WebApp.App.Administration.General.SystemSetting.View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <MAT:FormView ID="fvParent" runat="server" RenderOuterTable="false" DefaultMode="ReadOnly" ItemType="MAT.App.General.Parameter.SystemSetting.SystemSettingViewModel"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group m-form__group mat-form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <asp:DynamicControl runat="server" Mode="ReadOnly" DataField="EnableSsl" ID="EnableSsl" />
                                        </div>
                                    </div>
                                     <div class="form-group m-form__group mat-form-group">
