<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="MAT.WebApp.App.Administration.General.Entity.Edit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphButtons" runat="server">
    ...
    <Metronic:LinkButton ID="btnBack" runat="server" SkinID="ButtonBack" CausesValidation="false"></Metronic:LinkButton>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <MAT:FormView ID="fvParent" runat="server" RenderOuterTable="false" DataKeyNames="EntityId" DefaultMode="Edit"
        ItemType="MAT.App.General.Entity.EntityViewModel" SelectMethod="fvParent_GetItem"
        UpdateMethod="fvParent_UpdateItem">
        <EditItemTemplate>
            <div class="m-portlet">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="m-form__group mat-form-group">
                                ...
                                <div class="col-sm-8 col-xs-12">
                                    <MATAce:Avatar ID="avtLogo" runat="server" Edit="true" DestinationPath="Upload" Title="UploadLogo" ImagePath='<%# Eval("LogoPath") %>' />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
