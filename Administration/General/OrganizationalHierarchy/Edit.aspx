<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="MAT.WebApp.App.Administration.General.OrganizationalHierarchy.Edit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphButtons" runat="server">
    <Metronic:FormViewButton ID="btnUpdate" runat="server" SkinID="ButtonSave" AssociatedFormViewId="FormView1" FunctionAccessControlCode="Edit" CommandName="Update"></Metronic:FormViewButton>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="upParent" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <MAT:FormView ID="FormView1" runat="server" RenderOuterTable="false" DefaultMode="Edit" SelectMethod="FormView1_GetItem" UpdateMethod="FormView1_UpdateItem"
                ItemType="MAT.App.General.OrganizationalHierarchy.OrganizationalHierarchyViewModel" DataKeyNames="EntityId">
                <EditItemTemplate>
                    <div class="m-portlet">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group m-form__group mat-form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <asp:DynamicControl runat="server" Mode="Edit" DataField="EntityType" ID="EntityType" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="m-portlet__body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group m-form__group mat-form-group">
                                        <MAT:Label ID="Label4" runat="server" SkinID="FormLabel" AssociatedControlID="StreetAddress" Text="StreetAddress" />
                                        <div class="col-sm-7">
                                    ...
                                    <div class="form-group m-form__group mat-form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <asp:DynamicControl runat="server" Mode="Edit" DataField="EntityAddress2" ID="DynamicControl1" />
                                        </div>
                                    </div>
                                    <div class="form-group m-form__group mat-form-group">
                                        <MAT:Label ID="Label11" runat="server" SkinID="FormLabel" />
                                        <div class="col-sm-7">
                                            <asp:DynamicControl runat="server" Mode="Edit" DataField="EntityAddress3" ID="DynamicControl2" />
                                        </div>
                                    </div>
