<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAttachment.ascx.cs" Inherits="MAT.WebApp.App.TicketManagement.Ticket.UserControls.ucAttachment" %>
...
<div class="m-portlet">
    ...
    <div class="m-portlet__body">
        <div class="form-horizontal" role="form" id="uploadPanel" runat="server">
            ...
            <%--            <asp:FileUpload runat="server" ID="FileUpload" class="common-uploader" />
            <Metronic:LinkButton runat="server" ID="btnUpload" SkinID="ButtonUpload" CausesValidation="false" OnClick="btnUpload_Click" OnClientClick="return isFileSelected()"></Metronic:LinkButton>--%>
        </div>

        <div class="table-responsive">
            <Metronic:GridView runat="server" ID="GridView1" ItemType="MAT.App.General.Attachment.AttachmentViewModel" DataKeyNames="AttachmentId"
                SelectMethod="GridView1_GetData" OnRowCommand="GridView1_RowCommand" SkinID="Custom">
                <Columns>
