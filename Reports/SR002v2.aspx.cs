...
{
    public partial class SR002v2 : WebApp.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                getYear();
                getQuarter();
                UserId = Convert.ToString(MAT.Context.Profile.UserId);
            }
        }
        ...
        private string GetReportsHTML(string Year, string Quarter)
        {
            try
            {
                ...
                DataSet dsKPI = DataLayer.KPIList_SR002(Year, Quarter, UserId);
