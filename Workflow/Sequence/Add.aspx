<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="MAT.WebApp.App.Workflow.Sequence.Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphButtons" runat="server">
    <Metronic:FormViewButton ID="btnSave" runat="server" SkinID="ButtonSave" AssociatedFormViewId="fvWorkflowSequence" FunctionAccessControlCode="Create" CommandName="Insert"></Metronic:FormViewButton>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <MAT:FormView ID="fvWorkflowSequence" runat="server" RenderOuterTable="false" DataKeyNames="WorkflowSequenceId" DefaultMode="Insert"
        ItemType="MAT.App.Workflow.Sequence.WorkflowSequenceViewModel" InsertMethod="fvWorkflowSequence_InsertItem"
        OnItemInserting="fvWorkflowSequence_ItemInserting">
        <InsertItemTemplate>
            <div class="m-portlet">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group m-form__group mat-form-group">
                                ...
                                <div class="col-sm-7">
                                    <asp:DynamicControl runat="server" Mode="Insert" DataField="SequenceNo" ID="SequenceNo" />
                                </div>
                            </div>
                            <div class="form-group m-form__group mat-form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group m-form__group mat-form-group">
                                ...
                                <div class="col-sm-7">
                                    <Metronic:MultiSelect ID="WorkflowActions" runat="server" SelectMethod="WorkflowAction_Select" DataTextField="Value" DataValueField="Key"></Metronic:MultiSelect>
                                </div>
                            </div>
                            <div class="form-group m-form__group mat-form-group">
                                <MAT:Label runat="server" SkinID="FormLabel" Text="ManualAssignment" AssociatedControlID="ManualAssignment" />
                                <div class="col-sm-7">
                                    <asp:DynamicControl runat="server" Mode="Insert" DataField="ManualAssignment" ID="ManualAssignment" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="m-portlet__body">
                        <div class="tab-content">
                            <div class="tab-pane active show" id="assignments" role="tabpanel">
                                <UserControl:WorkflowSequenceAssignment ID="ucWorkflowSequenceAssignment" runat="server" Value='<%# Bind("Assignments") %>'
                            ...
                            <div class="tab-pane" id="emailnotifications" role="tabpanel">
                                <UserControl:WorkflowSequenceEmailNotification ID="ucWorkflowSequenceEmailNotification" runat="server" Value='<%# Bind("EmailNotifications") %>'
                                    WorkflowType='<%# GetDataCache<MAT.App.Workflow.WorkflowViewModel>().WorkflowType %>' />
                            </div>
                        </div>
                    </div>
