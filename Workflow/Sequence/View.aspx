<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="MAT.WebApp.App.Workflow.Sequence.View" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <MAT:FormView ID="fvWorkflowSequence" runat="server" RenderOuterTable="false" DataKeyNames="WorkflowSequenceId" DefaultMode="ReadOnly"
        ItemType="MAT.App.Workflow.Sequence.WorkflowSequenceViewModel" SelectMethod="fvWorkflowSequence_GetItem" OnDataBound="fvWorkflowSequence_DataBound">
        <ItemTemplate>
            <div class="m-portlet">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group m-form__group mat-form-group">
                                ...
                                <div class="col-sm-7">
                                    <asp:DynamicControl runat="server" Mode="ReadOnly" DataField="SequenceNo" ID="SequenceNo" />
                                </div>
                            </div>
                            <div class="form-group m-form__group mat-form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group m-form__group mat-form-group">
                                ...
                                <div class="col-sm-7">
                                    <asp:DynamicControl runat="server" Mode="ReadOnly" DataField="ManualAssignment" ID="ManualAssignment" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="m-portlet__body">
                        <div class="tab-content">
                            <div class="tab-pane active show" id="assignments" role="tabpanel">
                                <UserControl:WorkflowSequenceAssignment ID="WorkflowSequenceAssignment1" runat="server" Value='<%# Eval("Assignments") %>' ReadOnly="true" />
                            </div>
                            <div class="tab-pane" id="emailnotifications" role="tabpanel">
                                <UserControl:WorkflowSequenceEmailNotification ID="WorkflowSequenceEmailNotification1" runat="server" Value='<%# Eval("EmailNotifications") %>' ReadOnly="true" />
                            </div>
                        </div>
                    </div>
                </div>
