<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="MAT.WebApp.App.Scorecard.KPIProgress.ProgressSubmission.Edit" %>
...
<%@ Register Src="~/Scorecard/UserControl/ucAttachment.ascx" TagPrefix="MAT" TagName="ucAttachment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphButtons" runat="server">
    <UserControl:ucWorkflowSubmission runat="server" ID="ucWorkflowSubmission" OnSubmitClick="ucWorkflowSubmission_SubmitClick"
        OnWorkflowInitialising="ucWorkflowSubmission_WorkflowInitialising" OnWorkflowInitiated="ucWorkflowSubmission_WorkflowInitiated" ValidationGroup="SaveAndSubmit" />
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group m-form__group mat-form-group">
                                ...
                                <div class="col-sm-8">
                                    <MAT:Label runat="server" SkinID="FormValue" ID="Status" Text='<%# (MAT.App.Scorecard.Enumerate.ScorecardKpiDetailStatus)Item.ScorecardKpiDetailStatus %>'></MAT:Label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group m-form__group mat-form-group">
                                ...
                                <div class="col-sm-8">
                                    <MAT:Label runat="server" SkinID="FormValue" ID="Period" Text='<%# Item.Period + " " + Item.StartDate.Year.ToString() %>'></MAT:Label>
                                </div>
                            </div>
                            <div class="form-group m-form__group mat-form-group">
                                <MAT:Label runat="server" SkinID="FormLabel" Text="Target" AssociatedControlID="Target"></MAT:Label>
                                <div class="col-sm-8">
                                    <MAT:Label runat="server" SkinID="FormValue" ID="Target" Text='<%# Item.Target ?? 0 %>'></MAT:Label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group m-form__group mat-form-group">
                                ...
                                <div class="col-sm-8" runat="server" visible='<%#
                                    Item.ScorecardKpiDetailStatus == MAT.App.Scorecard.Enumerate.ScorecardKpiDetailStatus.New ||
                                    Item.ScorecardKpiDetailStatus == MAT.App.Scorecard.Enumerate.ScorecardKpiDetailStatus.Draft ||
                                    Item.ScorecardKpiDetailStatus == MAT.App.Scorecard.Enumerate.ScorecardKpiDetailStatus.Rework ||
                                    Item.ScorecardKpiDetailStatus == MAT.App.Scorecard.Enumerate.ScorecardKpiDetailStatus.Reopened ||
                                    Item.ScorecardKpiDetailStatus == MAT.App.Scorecard.Enumerate.ScorecardKpiDetailStatus.ReopenedRework %>'>
                                    <Metronic:TextBox runat="server" ID="Progress" Text='<%# BindItem.Actual %>' AutoPostBack="true"
                                        Mandatory="true" ValidationGroup="SaveAndSubmit" OnTextChanged="Progress_TextChanged"></Metronic:TextBox>
                                </div>
                                <div class="col-sm-8" runat="server" visible='<%#
                                    Item.ScorecardKpiDetailStatus == MAT.App.Scorecard.Enumerate.ScorecardKpiDetailStatus.Pending ||
                                    Item.ScorecardKpiDetailStatus == MAT.App.Scorecard.Enumerate.ScorecardKpiDetailStatus.Approved ||
                                    Item.ScorecardKpiDetailStatus == MAT.App.Scorecard.Enumerate.ScorecardKpiDetailStatus.ReopenedPending %>'>
                                    <MAT:Label runat="server" SkinID="FormValue" Text='<%# Item.Actual %>'></MAT:Label>
                                </div>
                            </div>
                            <div class="form-group m-form__group mat-form-group">
    ...
    <div class="tabbable">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="Document" role="tabpanel">
                <MAT:ucAttachment runat="server" ID="ucAttachment" Title="Evidences" Mode="Edit" />
            </div>
                            ...
                            <asp:Repeater runat="server" ID="rptKpiChecklist" SelectMethod="rptKpiChecklist_GetData"
                                ...
                                <ItemTemplate>
                                    <div class="col-md-12">
                                        ...
                                        <MAT:Label runat="server" Text="Mandatory" ForeColor="Red" Visible='<%# Item.IsRequired %>' Font-Size="X-Small"></MAT:Label>
                                    </div>
                                </ItemTemplate>
                            </asp:Repeater>
                        </div>
            ...
            <div class="tab-pane" id="ActivityLog" role="tabpanel">
                <UserControl:ucWorkflowInstanceHistory runat="server" ID="ucWorkflowInstanceHistory" />
            </div>
        </div>
    </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderScript" runat="server">
    ...
    <script type="text/javascript">
        function calculate() {
            var per, prog, tar;
            tar = document.getElementById('<%= fvParent.FindControl("Target").ClientID %>');
            prog = document.getElementById('<%= fvParent.FindControl("Progress").ClientID %>');
            per = document.getElementById('<%= fvParent.FindControl("Performance").ClientID %>');

            if (tar.innerText != 0)
                per.innerText = (prog.value * 100 / tar.innerText) + '%';
            else
                per.innerText = 0 + '%';
