<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="MAT.WebApp.App.Scorecard.KPIProgress.ProgressHistory.Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphButtons" runat="server">
    <UserControl:ucWorkflowSubmission runat="server" ID="ucWorkflowSubmission" OnSubmitClick="ucWorkflowSubmission_SubmitClick" Visible="false"
        OnWorkflowInitialising="ucWorkflowSubmission_WorkflowInitialising" OnWorkflowInitiated="ucWorkflowSubmission_WorkflowInitiated" ValidationGroup="ReopenAndSubmit" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <MAT:FormView runat="server" ID="fvParent" RenderOuterTable="false" DefaultMode="Edit"
        SelectMethod="fvParent_SelectItem" UpdateMethod="fvParent_UpdateItem" OnDataBound="fvParent_DataBound"
        ItemType="MAT.App.Scorecard.Scorecard.KpiProgress.ProgressSubmission.KpiProgressSubmissionDetailViewModel">
        <EditItemTemplate>
            <div class="m-portlet">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group m-form__group mat-form-group">
                                ...
                                <div class="col-sm-8">
                                    <Metronic:TextBox runat="server" ID="Progress" Text='<%# BindItem.Actual %>' OnTextChanged="Progress_TextChanged"
                                        AutoPostBack="true" Mandatory="true" ValidationGroup="ReopenAndSubmit"></Metronic:TextBox>
                                </div>
                            </div>
                            <div class="form-group m-form__group mat-form-group">
                                        ...
                                        <div class="m-accordion__item-content">
                                            <asp:Repeater runat="server" ID="rpt" SelectMethod="rpt_GetData">
                                                <ItemTemplate>
                                                    ...
                                                    <Metronic:LinkButton runat="server" ID="lnkbtn" Text='<%# Eval("ReportName") %>'
                                                        SkinID="ButtonFreeLink" OnClick="lnkbtn_Click" CausesValidation="false"></Metronic:LinkButton><br />
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </div>
                                    </div>
            ...
            <div class="m-portlet">
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <Metronic:LinkButton runat="server" ID="btnPreview" SkinID="ButtonFreeText" Text="Preview"
                            OnClick="btnPreview_Click" CausesValidation="false"></Metronic:LinkButton>
                    </div>
                </div>
                <div class="m-portlet__body">
                    <asp:DynamicControl runat="server" ID="Note" Mode="Edit" DataField="Note" ValidationGroup="ReopenAndSubmit" OnDataBinding="Note_DataBinding" />
                </div>
            </div>
        </EditItemTemplate>
    </MAT:FormView>
    ...
    <div class="tabbable">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="Document" role="tabpanel">
                <UserControl:ucAttachment runat="server" ID="ucAttachment" Mode="ReadOnly" Title="Evidences" />
            </div>
