<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="MAT.WebApp.App.Scorecard.KPIProgress.ProgressHistory.View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphButtons" runat="server">
    <Metronic:LinkButton runat="server" ID="btnReopen" CausesValidation="false" SkinID="ButtonFreeText" Text="Reopen" OnClick="btnReopen_Click"></Metronic:LinkButton>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <MAT:FormView runat="server" ID="fvParent" RenderOuterTable="false"
        SelectMethod="fvParent_SelectItem" OnDataBound="fvParent_DataBound"
        ...
        <ItemTemplate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group m-form__group mat-form-group">
                                ...
                                <div class="col-sm-8">
                                    <MAT:Label runat="server" ID="Progress" SkinID="FormValue" Text='<%# Item.Actual %>'></MAT:Label>
                                </div>
                            </div>
                            <div class="form-group m-form__group mat-form-group">
            ...
            <div class="m-portlet">
                ...
                <div class="m-portlet__body">
                    <asp:DynamicControl runat="server" Mode="ReadOnly" DataField="Note" />
                </div>
            </div>
        </ItemTemplate>
