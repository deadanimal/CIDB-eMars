<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="Edit.aspx.cs" Inherits="MAT.WebApp.App.Scorecard.PerformanceScorecard.ChangeRequest.Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphButtons" runat="server">
    <UserControl:WorkflowSubmission ID="ucWorkflowSubmission" runat="server" OnSubmitClick="ucWorkflowSubmission_SubmitClick"
    ...
    <Metronic:LinkButton runat="server" ID="btnCancel" SkinID="ButtonBack"></Metronic:LinkButton>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <MAT:FormView runat="server" ID="fvChangeRequest" RenderOuterTable="false" DataKeyNames="KpiChangeRequestId"
        DefaultMode="Edit" SelectMethod="fvChangeRequest_GetItem" UpdateMethod="fvChangeRequest_UpdateItem"
        OnItemUpdating="fvChangeRequest_ItemUpdating" OnDataBound="fvChangeRequest_DataBound"
        ...
        <EditItemTemplate>
                                    ...
                                    <asp:Repeater ID="rptWeightage" runat="server" SelectMethod="rptWeightages_Get" OnItemCommand="rptWeightage_ItemCommand" OnPreRender="rptWeightage_PreRender">
                                        <ItemTemplate>
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group m-form__group mat-form-group">
                                                        <asp:LinkButton ID="btnDelete" Text="Delete" runat="server" CommandName="Delete" CommandArgument='<%# Eval("ScorecardKpiWeightId") %>' />
                                                    </div>
                                                </div>
                                            </div>
                                        </ItemTemplate>
                                        ...
                                        <asp:Repeater ID="rptTarget" runat="server" SelectMethod="rptTargets_Get" OnItemCommand="rptTarget_ItemCommand" OnPreRender="rptTarget_PreRender">
                                            <ItemTemplate>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group m-form__group mat-form-group">
                                                            <asp:LinkButton ID="btnDelete" Text="Delete" runat="server" CommandName="Delete" CommandArgument='<%# Eval("ScorecardKpiDetailId") %>' />
                                                        </div>
                                                    </div>
                                                </div>
                                            </ItemTemplate>
            ...
            <UserControl:WorkflowInstanceHistory ID="ucWorkflowInstanceHistory" runat="server" OwnerId='<%# Item.KpiChangeRequestId %>' />
        </EditItemTemplate>
        <ItemTemplate>
            <div class="row">
                <div class="col-md-12">
