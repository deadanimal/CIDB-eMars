<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="MAT.WebApp.App.Scorecard.PerformanceScorecard.UnitMaster.Edit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <MAT:FormView runat="server" ID="fvParent" RenderOuterTable="false" DefaultMode="Edit" ItemType="MAT.App.Scorecard.DbModels.ScorecardUnit" SelectMethod="fvParent_SelectItem" UpdateMethod="fvParent_UpdateItem" DataKeyNames="ScorecardUnitId">
        <EditItemTemplate>
            <div class="m-portlet">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group m-form__group mat-form-group">
                                ...
                                <div class="col-sm-8">
                                    <Metronic:DropDownList runat="server" ID="MeasureType" SelectMethod="MeasureType_Get" DataTextField="Value" DataValueField="Key" Text='<%# Item.MeasureType %>'></Metronic:DropDownList>
                                </div>
                            </div>                            
                            <div class="form-group m-form__group mat-form-group">
