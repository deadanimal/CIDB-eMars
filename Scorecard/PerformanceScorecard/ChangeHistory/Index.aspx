<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="MAT.WebApp.App.Scorecard.PerformanceScorecard.ChangeHistory.Index" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="m-portlet">
                <div class="m-portlet__body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group m-form__group mat-form-group">
                                <MAT:Label runat="server" SkinID="FormLabel" Text="Approver Name" AssociatedControlID="txtApproverName"></MAT:Label>
                                <div class="col-sm-8">
                                    <Metronic:TextBox runat="server" ID="txtApproverName"></Metronic:TextBox>
                                </div>
                            </div>
                            <div class="form-group m-form__group mat-form-group">
    ...
    <Metronic:GridView runat="server" ID="gvList" DataKeyNames="KpiChangeRequestId" SelectMethod="gvList_Get" 
        ...
        <Columns>
            <MAT:TemplateField ItemStyle-Width="20px">
                <ItemTemplate>
                    <Metronic:LinkButton runat="server" ID="btnView" SkinID="ButtonViewIcon" OnClick="btnView_Click" 
                        CommandArgument='<%# Item.KpiChangeRequestId %>' CausesValidation="false"></Metronic:LinkButton>
                </ItemTemplate>
            </MAT:TemplateField>
            ...
            <MAT:BoundField HeaderText="ApprovedDate" DataField="ApprovedDate" DataFormatString="{0:dd/MM/yyyy}"></MAT:BoundField>
            <MAT:TemplateField HeaderText="ApprovedBy">
                <ItemTemplate>
                    <%# GetDisplayName(Item.ApproverUId) %>
                </ItemTemplate>
            </MAT:TemplateField>
