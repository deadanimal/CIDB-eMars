<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="MAT.WebApp.App.Scorecard.PerformanceScorecard.ScorecardApproval.Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphButtons" runat="server">
    <Metronic:FormViewButton runat="server" ID="btnSave" SkinID="ButtonSave" AssociatedFormViewId="fvParent"
        FunctionAccessControlCode="Edit" CommandName="Update" ValidationGroup="UpdateFormView"></Metronic:FormViewButton>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <MAT:FormView runat="server" ID="fvParent" RenderOuterTable="false" DefaultMode="Edit"
        ...
        ItemType="MAT.App.Scorecard.Scorecard.Shared.ScorecardViewModel">
        <EditItemTemplate>
            <UserControl:ucWorkflowAction runat="server" ID="ucWorkflowAction" WorkflowInstanceDetailId='<%# WorkflowInstanceDetailId %>'
                OnPreAction="ucWorkflowAction_PreAction" OnPostAction="ucWorkflowAction_PostAction"
                Visible='<%# WorkflowInstanceDetailStatus == MAT.App.Workflow.Instance.WorkflowInstanceDetailStatus.Pending %>'
                OnSuccess="ucWorkflowAction_Success" ValidationGroup="WorkflowAction" />
            <div class="m-portlet">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group m-form__group mat-form-group">
                                ...
                                <div class="col-sm-8">
                                    <Metronic:TextBox runat="server" ID="Name" Text='<%# BindItem.Name %>' Mandatory="true" ValidationGroup="UpdateFormView"></Metronic:TextBox>
                                </div>
                            </div>
                            <div class="form-group m-form__group mat-form-group">
                                <MAT:Label runat="server" SkinID="FormLabel" Text="Frequency" AssociatedControlID="Frequency"></MAT:Label>
                                <div class="col-sm-8">
                                    <MAT:Label runat="server" ID="Frequency" SkinID="FormValue"
                                        Text='<%# (MAT.App.Scorecard.Enumerate.ScorecardFrequency)Item.Frequency %>'></MAT:Label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group m-form__group mat-form-group">
                                ...
                                <div class="col-sm-8">
                                    <Metronic:TextBox runat="server" ID="Objective" Text='<%# BindItem.Objectives %>' ValidationGroup="UpdateFormView"></Metronic:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="m-portlet__body">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-xs-12">
                                        <UserControl:ucInitiativeDetail runat="server" ID="ucInitiativeDetail" Visible="false"
                                            OnChanged="ucInitiativeDetail_Changed"/>
                                        <UserControl:ucKpiDetail runat="server" ID="ucKpiDetail" Visible="false" 
                                            OnChanged="ucKpiDetail_Changed" />
                                    </div>
                                </div>
                            </div>
                        </div>
